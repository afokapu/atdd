...
| acc:validate-conventions:E006-SMOKE-001-seed | seed (PLANNED stub; concrete SMOKE authored in #1205 RED) | every file under the four legacy validator roots appears in the parity map or exclusion table | legacy roots -> parity map completeness scan | #1205 (pending RED) |
| acc:validate-conventions:E007-SMOKE-001-seed | seed (PLANNED stub; concrete SMOKE authored in #1205 RED) | every mapped entry uses a canonical family/template from the #1204 registry | parity entry -> registry lookup | #1205 (pending RED) |
| acc:validate-conventions:E008-SMOKE-001-seed | seed (PLANNED stub; concrete SMOKE authored in #1205 RED) | every entry carries a valid parity_status enum + P0/P1/P2 priority | parity entry field validation | #1205 (pending RED) |
| acc:validate-conventions:E009-SMOKE-001-seed | seed (PLANNED stub; concrete SMOKE authored in #1205 RED) | every excluded file carries an explicit reason | exclusion table reason check | #1205 (pending RED) |
...
| acc:validate-conventions:E012-SMOKE-001-seed | seed (PLANNED stub; concrete SMOKE authored in #1206 RED) | every P1 entry is implemented or deferred with a recorded reason | parity map P1 -> impl or deferral record | #1206 (pending RED) |
...
| acc:validate-conventions:E016-SMOKE-001-seed | seed (PLANNED stub; concrete SMOKE authored in #1207 RED) | shadow-run report shows zero unresolved P0 parity gaps | shadow comparison -> report | #1207 (pending RED) |
| acc:validate-conventions:E017-SMOKE-001-seed | seed (PLANNED stub; concrete SMOKE authored in #1207 RED) | decommission report records an outcome for every legacy validator, 1:1 with the audit | decommission report <-> parity audit reconcile | #1207 (pending RED) |
...
| acc:validate-conventions:Y001-SMOKE-001-seed | seed (PLANNED stub; concrete SMOKE authored in #1207 RED) | deletion refused unless parity status in {direct,merged,split,superseded} and target exists | decommission safety guard | #1207 (pending RED) |
| acc:validate-conventions:Y002-SMOKE-001-seed | real (live checkout, scripts/decommission_manifest.py::classify over the real ready-set) | known platform / rule-bound / acceptance-anchored legacy validators partition into distinct label sets with correct required steps + both CI catches named | classify(repo_root) -> per-candidate labels + required steps | #1263 (live verified 2026-06-30; partitions 32 ready candidates, flags the 2 stale-map entries that tripped batch 2 #1260) |
...
| acc:validate-conventions:E022-SMOKE-001-seed | seed (PLANNED stub; concrete SMOKE authored in #1211 RED) | each ported P0 variant has a fault-injection parity test vs legacy | convention validator -> real graph -> gate | #1211 (pending RED) |
| acc:validate-conventions:E023-SMOKE-001-seed | seed (PLANNED stub; concrete SMOKE authored in #1211 RED) | no parity-verified mark without a passing legacy-vs-convention diff | convention validator -> real graph -> gate | #1211 (pending RED) |
| acc:validate-conventions:E024-SMOKE-001-seed | seed (PLANNED stub; concrete SMOKE authored in #1211 RED) | each convention-only finding classified real-gap/schema-bug/loader-bug | convention validator -> real graph -> gate | #1211 (pending RED) |
...
| acc:validate-conventions:E027-SMOKE-001-seed | seed (PLANNED stub; concrete SMOKE authored in #1212 RED) | seeded fault per legacy rule + clean baseline exist | convention validator -> real graph -> gate | #1212 (pending RED) |
| acc:validate-conventions:E028-SMOKE-001-seed | seed (PLANNED stub; concrete SMOKE authored in #1212 RED) | each fault run through both legacy and convention suites | convention validator -> real graph -> gate | #1212 (pending RED) |
| acc:validate-conventions:E029-SMOKE-001-seed | seed (PLANNED stub; concrete SMOKE authored in #1212 RED) | each fault yields a catch-matrix cell | convention validator -> real graph -> gate | #1212 (pending RED) |
| acc:validate-conventions:E030-SMOKE-001-seed | seed (PLANNED stub; concrete SMOKE authored in #1212 RED) | neither suite flags the clean baseline | convention validator -> real graph -> gate | #1212 (pending RED) |
| acc:validate-conventions:E031-SMOKE-001-seed | seed (PLANNED stub; concrete SMOKE authored in #1212 RED) | gap report quantifies parity/improvements/regressions/FPs | convention validator -> real graph -> gate | #1212 (pending RED) |
