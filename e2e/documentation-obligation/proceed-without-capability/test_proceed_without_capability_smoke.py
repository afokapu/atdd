# URN: test:train:documentation-obligation:proceed-without-capability:E2E-001-declaration-smoke
# Train: train:documentation-obligation:proceed-without-capability
# Phase: SMOKE
# Layer: assembly
# Runtime: python
# Smoke: true
# Purpose: The alternate route of the documentation-obligation journey is declared, registered and
#          bilaterally bound to its interlocking, read through the real loaders over the real tree.
"""Smoke test for train:documentation-obligation:proceed-without-capability.
...
Route: NOT_APPLICABLE -> proceed-without-capability (alternate) — no documentation capability is installed, so nothing is judged.
"""
...
TRAIN_ID = "train:documentation-obligation:proceed-without-capability"
INTERLOCKING = REPO_ROOT / "plan/_trains/_interlockings/govern-documentation-obligation.yaml"
TRAIN_FILE = REPO_ROOT / "plan/_trains/documentation-obligation/proceed-without-capability.yaml"
...
def test_the_train_is_declared_on_disk() -> None:
    ...
    assert train["category"] == "alternate"
