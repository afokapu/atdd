# URN: test:train:documentation-obligation:remediate-undischarged-obligation:E2E-001-declaration-smoke
# Train: train:documentation-obligation:remediate-undischarged-obligation
# Phase: SMOKE
# Layer: assembly
# Runtime: python
# Smoke: true
# Purpose: The exception route of the documentation-obligation journey is declared, registered and
#          bilaterally bound to its interlocking, read through the real loaders over the real tree.
"""Smoke test for train:documentation-obligation:remediate-undischarged-obligation.
...
Route: FAIL -> remediate-undischarged-obligation (exception) — the obligation was declared and observed undischarged.
"""
...
TRAIN_ID = "train:documentation-obligation:remediate-undischarged-obligation"
INTERLOCKING = REPO_ROOT / "plan/_trains/_interlockings/govern-documentation-obligation.yaml"
TRAIN_FILE = REPO_ROOT / "plan/_trains/documentation-obligation/remediate-undischarged-obligation.yaml"
...
def test_the_train_is_declared_on_disk() -> None:
    ...
    assert train["category"] == "exception"
