# URN: test:train:documentation-obligation:prove-documentation-obligation:E2E-001-declaration-smoke
# Train: train:documentation-obligation:prove-documentation-obligation
# Phase: SMOKE
# Layer: assembly
# Runtime: python
# Smoke: true
# Purpose: The nominal route of the documentation-obligation journey is declared, registered and
#          bilaterally bound to its interlocking, read through the real loaders over the real tree.
"""Smoke test for train:documentation-obligation:prove-documentation-obligation.
...
Route: PASS -> prove-documentation-obligation (nominal) — the obligation is declared, discharged and verified at COMPLETE and merge.
"""
...
TRAIN_ID = "train:documentation-obligation:prove-documentation-obligation"
INTERLOCKING = REPO_ROOT / "plan/_trains/_interlockings/govern-documentation-obligation.yaml"
TRAIN_FILE = REPO_ROOT / "plan/_trains/documentation-obligation/prove-documentation-obligation.yaml"
