# URN: test:train:extension-conventions:enforce-strict-failure:E2E-001-strict-violation-fails-route-projects
# Train: train:extension-conventions:enforce-strict-failure
# Phase: SMOKE
# Layer: assembly
# Runtime: python
# Smoke: true
# Assertion: behavioral
# Purpose: Train-level SMOKE for train:extension-conventions:enforce-strict-failure — the strict-violation route: a strict node's FAIL exits the enforce job non-zero.
...
interlocking projects onto train train:extension-conventions:enforce-strict-failure's linear sequence.
...
TRAIN_ID = "train:extension-conventions:enforce-strict-failure"
