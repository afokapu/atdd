# URN: test:train:extension-conventions:detect-unrealized-obligation:E2E-001-unrealized-obligation-detected-route-projects
# Train: train:extension-conventions:detect-unrealized-obligation
# Phase: SMOKE
# Layer: assembly
# Runtime: python
# Smoke: true
# Assertion: behavioral
# Purpose: Train-level SMOKE for train:extension-conventions:detect-unrealized-obligation — the unrealized-obligation route: a gating node declared but realized by no provider implementation.
...
interlocking projects onto train train:extension-conventions:detect-unrealized-obligation's linear sequence.
...
TRAIN_ID = "train:extension-conventions:detect-unrealized-obligation"
