# URN: test:train:extension-conventions:detect-unbound-declaration:E2E-001-unbound-declaration-detected-route-projects
# Train: train:extension-conventions:detect-unbound-declaration
# Phase: SMOKE
# Layer: assembly
# Runtime: python
# Smoke: true
# Assertion: behavioral
# Purpose: Train-level SMOKE for train:extension-conventions:detect-unbound-declaration — the latent-hole route: a gating node realized+unbound while its core twin still enforces it.
...
interlocking projects onto train train:extension-conventions:detect-unbound-declaration's linear sequence.
...
TRAIN_ID = "train:extension-conventions:detect-unbound-declaration"
