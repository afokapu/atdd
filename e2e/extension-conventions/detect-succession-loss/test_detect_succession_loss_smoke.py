# URN: test:train:extension-conventions:detect-succession-loss:E2E-001-succession-loss-blocked-route-projects
# Train: train:extension-conventions:detect-succession-loss
# Phase: SMOKE
# Layer: assembly
# Runtime: python
# Smoke: true
# Assertion: behavioral
# Purpose: Train-level SMOKE for train:extension-conventions:detect-succession-loss — the succession-loss route: a gating node unbound and its core twin deleted -> enforcement vanished, guard blocks.
...
interlocking projects onto train train:extension-conventions:detect-succession-loss's linear sequence.
...
TRAIN_ID = "train:extension-conventions:detect-succession-loss"
