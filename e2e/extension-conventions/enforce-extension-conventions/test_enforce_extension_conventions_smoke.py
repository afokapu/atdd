# URN: test:train:extension-conventions:enforce-extension-conventions:E2E-001-clean-gate-passes-route-projects
# Train: train:extension-conventions:enforce-extension-conventions
# Phase: SMOKE
# Layer: assembly
# Runtime: python
# Smoke: true
# Assertion: behavioral
# Purpose: Train-level SMOKE for train:extension-conventions:enforce-extension-conventions — the clean-gate route: every gating node is realized, bound, and reports no strict violation.
...
interlocking projects onto train train:extension-conventions:enforce-extension-conventions's linear sequence.
...
TRAIN_ID = "train:extension-conventions:enforce-extension-conventions"
