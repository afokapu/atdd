# URN: test:train:extension-conventions:report-advisory-violation:E2E-001-advisory-violation-reports-route-projects
# Train: train:extension-conventions:report-advisory-violation
# Phase: SMOKE
# Layer: assembly
# Runtime: python
# Smoke: true
# Assertion: behavioral
# Purpose: Train-level SMOKE for train:extension-conventions:report-advisory-violation — the advisory-violation route: an advisory node's violations are reported, job passes.
...
#          wagons land.
"""Train-level SMOKE: the advisory-violation-reports route of the enforce-extension-conventions
interlocking projects onto train train:extension-conventions:report-advisory-violation's linear sequence.
...
TRAIN_ID = "train:extension-conventions:report-advisory-violation"


def test_report_advisory_violation_route_projects_onto_train_sequence() -> None:
