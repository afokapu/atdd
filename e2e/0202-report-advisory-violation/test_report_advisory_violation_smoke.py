# URN: test:train:0202-report-advisory-violation:E2E-001-advisory-violation-reports-route-projects
# Train: train:0202-report-advisory-violation
# Phase: SMOKE
# Layer: assembly
# Runtime: python
# Smoke: true
# Assertion: behavioral
# Purpose: Train-level SMOKE for 0202-report-advisory-violation — the advisory-violation route: an advisory node's violations are reported, job passes.
...
interlocking projects onto train 0202-report-advisory-violation's linear sequence.
