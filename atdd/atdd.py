...
# Add coach to path for imports
ATDD_DIR = Path(__file__).parent
sys.path.insert(0, str(ATDD_DIR))

from coach.commands.inventory import RepositoryInventory
from coach.commands.test_runner import TestRunner
from coach.commands.registry import RegistryUpdater
