# URN: test:validate-conventions:presence-variants:wagon_trains_export_shape
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `presence/wagon_trains_export_shape` (#1206).
...
VARIANT = "wagon_trains_export_shape"
...
LEGACY_PARITY_SOURCES = ['src/atdd/coder/validators/test_wagon_trains_export_shape.py']


def test_wagon_trains_export_shape_variant_contract() -> None:
