# URN: test:validate-conventions:presence-variants:acceptance_measurable
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `presence/acceptance_measurable` (#1206).
...
LEGACY_PARITY_SOURCES = ['src/atdd/tester/validators/test_acceptance_measurable.py']


def test_acceptance_measurable_variant_contract() -> None:
