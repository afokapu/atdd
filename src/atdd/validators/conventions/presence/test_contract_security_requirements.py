# URN: test:validate-conventions:presence-variants:contract_security_requirements
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `presence/contract_security_requirements` (#1206).
...
VARIANT = "contract_security_requirements"
...
LEGACY_PARITY_SOURCES = ['src/atdd/tester/validators/test_contract_security.py']


def test_contract_security_requirements_variant_contract() -> None:
