# URN: test:validate-conventions:presence-variants:typescript_test_structure
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `presence/typescript_test_structure` (#1206).
...
VARIANT = "typescript_test_structure"
...
LEGACY_PARITY_SOURCES = ['src/atdd/tester/validators/test_typescript_test_structure.py']


def test_typescript_test_structure_variant_contract() -> None:
