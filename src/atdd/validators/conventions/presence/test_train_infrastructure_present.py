# URN: test:validate-conventions:presence-variants:train_infrastructure_present
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `presence/train_infrastructure_present` (#1206).
...
VARIANT = "train_infrastructure_present"
...
LEGACY_PARITY_SOURCES = ['src/atdd/coder/validators/test_train_infrastructure.py']


def test_train_infrastructure_present_variant_contract() -> None:
