# URN: test:validate-conventions:presence-variants:claude_md_references_emergency_doc
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `presence/claude_md_references_emergency_doc` (#1206).
...
VARIANT = "claude_md_references_emergency_doc"
...
LEGACY_PARITY_SOURCES = ['src/atdd/coach/validators/test_e022_unit_002_claude_md_references_operator_emergency_bypass_doc.py']


def test_claude_md_references_emergency_doc_variant_contract() -> None:
