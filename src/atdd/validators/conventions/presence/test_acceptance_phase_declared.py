# URN: test:validate-conventions:presence-variants:acceptance_phase_declared
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `presence/acceptance_phase_declared` (#1206).
...
VARIANT = "acceptance_phase_declared"
...
LEGACY_PARITY_SOURCES = ['src/atdd/tester/validators/test_acceptance_phase.py']


def test_acceptance_phase_declared_variant_contract() -> None:
