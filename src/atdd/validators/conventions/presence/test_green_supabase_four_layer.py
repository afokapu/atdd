# URN: test:validate-conventions:presence-variants:green_supabase_four_layer
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `presence/green_supabase_four_layer` (#1206).
...
VARIANT = "green_supabase_four_layer"
...
LEGACY_PARITY_SOURCES = ['src/atdd/coder/validators/test_green_supabase_layer_structure.py']


def test_green_supabase_four_layer_variant_contract() -> None:
