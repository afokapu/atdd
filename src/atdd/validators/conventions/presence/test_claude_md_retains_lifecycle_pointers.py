# URN: test:validate-conventions:presence-variants:claude_md_retains_lifecycle_pointers
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `presence/claude_md_retains_lifecycle_pointers` (#1206).
...
VARIANT = "claude_md_retains_lifecycle_pointers"
...
LEGACY_PARITY_SOURCES = ['src/atdd/coach/validators/test_e023_unit_002_claude_md_retains_atdd_lifecycle_and_command_pointers.py']


def test_claude_md_retains_lifecycle_pointers_variant_contract() -> None:
