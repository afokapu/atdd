# URN: test:validate-conventions:presence-variants:hermetic_fake_contract_declared
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `presence/hermetic_fake_contract_declared` (#1206).
...
VARIANT = "hermetic_fake_contract_declared"
...
LEGACY_PARITY_SOURCES = ['src/atdd/tester/validators/test_hermetic_integration_contract.py']


def test_hermetic_fake_contract_declared_variant_contract() -> None:
