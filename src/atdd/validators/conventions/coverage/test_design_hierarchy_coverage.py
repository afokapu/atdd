# URN: test:validate-conventions:coverage-variants:design_hierarchy_coverage
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `coverage/design_hierarchy_coverage` (#1206).
...
VARIANT = "design_hierarchy_coverage"
...
LEGACY_PARITY_SOURCES = ['src/atdd/coder/validators/test_hierarchy_coverage.py']


def test_design_hierarchy_coverage_variant_contract() -> None:
