# URN: test:validate-conventions:coverage-variants:smoke_coverage
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `coverage/smoke_coverage` (#1206).
...
LEGACY_PARITY_SOURCES = ['src/atdd/tester/validators/test_smoke_coverage.py']


def test_smoke_coverage_variant_contract() -> None:
