# URN: test:validate-conventions:coverage-variants:composition_root_completeness
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `coverage/composition_root_completeness` (#1206).
...
VARIANT = "composition_root_completeness"
...
LEGACY_PARITY_SOURCES = ['src/atdd/coder/validators/test_composition_completeness.py']


def test_composition_root_completeness_variant_contract() -> None:
