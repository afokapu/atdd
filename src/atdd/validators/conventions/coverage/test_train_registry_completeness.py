# URN: test:validate-conventions:coverage-variants:train_registry_completeness
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `coverage/train_registry_completeness` (#1206).
...
VARIANT = "train_registry_completeness"
...
LEGACY_PARITY_SOURCES = ['src/atdd/coach/validators/test_train_registry.py']


def test_train_registry_completeness_variant_contract() -> None:
