# URN: test:validate-conventions:coverage-variants:coverage_adequacy
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `coverage/coverage_adequacy` (#1206).
...
LEGACY_PARITY_SOURCES = ['src/atdd/tester/validators/test_coverage_adequacy.py']


def test_coverage_adequacy_variant_contract() -> None:
