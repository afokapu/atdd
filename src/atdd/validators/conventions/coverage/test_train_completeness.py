# URN: test:validate-conventions:coverage-variants:train_completeness
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `coverage/train_completeness` (#1206).
...
LEGACY_PARITY_SOURCES = ['src/atdd/tester/validators/test_train_completeness.py']


def test_train_completeness_variant_contract() -> None:
