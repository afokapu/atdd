# URN: test:validate-conventions:coverage-variants:presentation_ratchet_requires_smoke
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `coverage/presentation_ratchet_requires_smoke` (#1206).
...
VARIANT = "presentation_ratchet_requires_smoke"
...
LEGACY_PARITY_SOURCES = ['src/atdd/coder/validators/test_presentation_ratchet_requires_smoke.py']


def test_presentation_ratchet_requires_smoke_variant_contract() -> None:
