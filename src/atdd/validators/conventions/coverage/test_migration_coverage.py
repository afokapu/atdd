# URN: test:validate-conventions:coverage-variants:migration_coverage
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `coverage/migration_coverage` (#1206).
...
LEGACY_PARITY_SOURCES = ['src/atdd/tester/validators/test_migration_coverage.py']


def test_migration_coverage_variant_contract() -> None:
