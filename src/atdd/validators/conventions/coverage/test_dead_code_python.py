# URN: test:validate-conventions:coverage-variants:dead_code_python
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `coverage/dead_code_python` (#1206).
...
LEGACY_PARITY_SOURCES = ['src/atdd/coder/validators/test_dead_code_python.py']


def test_dead_code_python_variant_contract() -> None:
