# URN: test:validate-conventions:coverage-variants:wheel_fixture_completeness
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `coverage/wheel_fixture_completeness` (#1206).
...
VARIANT = "wheel_fixture_completeness"
...
LEGACY_PARITY_SOURCES = ['src/atdd/coach/validators/test_wheel_completeness.py']


def test_wheel_fixture_completeness_variant_contract() -> None:
