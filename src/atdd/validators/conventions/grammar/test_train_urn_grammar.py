# URN: test:validate-conventions:grammar-variants:train_urn_grammar
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `grammar/train_urn_grammar` (#1206).
...
LEGACY_PARITY_SOURCES = ['src/atdd/coder/validators/test_train_urns.py']


def test_train_urn_grammar_variant_contract() -> None:
