# URN: test:validate-conventions:grammar-variants:red_python_layer_structure
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `grammar/red_python_layer_structure` (#1206).
...
VARIANT = "red_python_layer_structure"
...
LEGACY_PARITY_SOURCES = ['src/atdd/tester/validators/test_red_python_layer_structure.py']


def test_red_python_layer_structure_variant_contract() -> None:
