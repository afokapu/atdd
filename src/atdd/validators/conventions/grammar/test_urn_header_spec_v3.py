# URN: test:validate-conventions:grammar-variants:urn_header_spec_v3
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `grammar/urn_header_spec_v3` (#1206).
...
LEGACY_PARITY_SOURCES = ['src/atdd/tester/validators/test_urn_spec_v3.py']


def test_urn_header_spec_v3_variant_contract() -> None:
