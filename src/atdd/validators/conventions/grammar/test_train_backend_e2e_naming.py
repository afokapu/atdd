# URN: test:validate-conventions:grammar-variants:train_backend_e2e_naming
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `grammar/train_backend_e2e_naming` (#1206).
...
VARIANT = "train_backend_e2e_naming"
...
LEGACY_PARITY_SOURCES = ['src/atdd/tester/validators/test_train_backend_e2e.py']


def test_train_backend_e2e_naming_variant_contract() -> None:
