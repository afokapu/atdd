# URN: test:validate-conventions:grammar-variants:python_test_naming
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `grammar/python_test_naming` (#1206).
...
LEGACY_PARITY_SOURCES = ['src/atdd/tester/validators/test_python_test_naming.py']


def test_python_test_naming_variant_contract() -> None:
