# URN: test:validate-conventions:grammar-variants:theme_must_be_canonical
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `grammar/theme_must_be_canonical` (#1206).
...
VARIANT = "theme_must_be_canonical"
...
LEGACY_PARITY_SOURCES = ['src/atdd/planner/validators/test_theme_must_be_canonical.py']


def test_theme_must_be_canonical_variant_contract() -> None:
