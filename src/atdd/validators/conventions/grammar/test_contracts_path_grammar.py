# URN: test:validate-conventions:grammar-variants:contracts_path_grammar
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `grammar/contracts_path_grammar` (#1206).
...
VARIANT = "contracts_path_grammar"
...
LEGACY_PARITY_SOURCES = ['src/atdd/tester/validators/test_contracts_structure.py']


def test_contracts_path_grammar_variant_contract() -> None:
