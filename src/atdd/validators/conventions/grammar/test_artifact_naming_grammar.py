# URN: test:validate-conventions:grammar-variants:artifact_naming_grammar
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `grammar/artifact_naming_grammar` (#1206).
...
VARIANT = "artifact_naming_grammar"
...
LEGACY_PARITY_SOURCES = ['src/atdd/tester/validators/test_artifact_naming_category.py']


def test_artifact_naming_grammar_variant_contract() -> None:
