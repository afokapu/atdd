# URN: test:validate-conventions:grammar-variants:init_file_urn_grammar
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `grammar/init_file_urn_grammar` (#1206).
...
LEGACY_PARITY_SOURCES = ['src/atdd/coder/validators/test_init_file_urns.py']


def test_init_file_urn_grammar_variant_contract() -> None:
