# URN: test:validate-conventions:grammar-variants:acceptance_urn_grammar
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `grammar/acceptance_urn_grammar` (#1206).
...
VARIANT = "acceptance_urn_grammar"
...
LEGACY_PARITY_SOURCES = ['src/atdd/tester/validators/test_acceptance_urn_separator.py']


def test_acceptance_urn_grammar_variant_contract() -> None:
