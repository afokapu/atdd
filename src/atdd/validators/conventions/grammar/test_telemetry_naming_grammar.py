# URN: test:validate-conventions:grammar-variants:telemetry_naming_grammar
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `grammar/telemetry_naming_grammar` (#1206).
...
VARIANT = "telemetry_naming_grammar"
...
LEGACY_PARITY_SOURCES = ['src/atdd/tester/validators/test_telemetry_structure.py']


def test_telemetry_naming_grammar_variant_contract() -> None:
