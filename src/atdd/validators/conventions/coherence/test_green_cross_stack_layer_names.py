# URN: test:validate-conventions:coherence-variants:green_cross_stack_layer_names
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `coherence/green_cross_stack_layer_names` (#1206).
...
VARIANT = "green_cross_stack_layer_names"
...
LEGACY_PARITY_SOURCES = ['src/atdd/coder/validators/test_green_cross_stack_layers.py']


def test_green_cross_stack_layer_names_variant_contract() -> None:
