# URN: test:validate-conventions:coherence-variants:cross_language_consistency
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `coherence/cross_language_consistency` (#1206).
...
VARIANT = "cross_language_consistency"
...
LEGACY_PARITY_SOURCES = ['src/atdd/coder/validators/test_cross_language_consistency.py']


def test_cross_language_consistency_variant_contract() -> None:
