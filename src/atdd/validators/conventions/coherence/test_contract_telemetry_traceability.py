# URN: test:validate-conventions:coherence-variants:contract_telemetry_traceability
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `coherence/contract_telemetry_traceability` (#1206).
...
VARIANT = "contract_telemetry_traceability"
...
LEGACY_PARITY_SOURCES = ['src/atdd/coach/validators/test_traceability.py']


def test_contract_telemetry_traceability_variant_contract() -> None:
