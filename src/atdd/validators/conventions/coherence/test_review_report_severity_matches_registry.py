# URN: test:validate-conventions:coherence-variants:review_report_severity_matches_registry
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `coherence/review_report_severity_matches_registry` (#1206).
...
VARIANT = "review_report_severity_matches_registry"
...
LEGACY_PARITY_SOURCES = ['src/atdd/coach/validators/test_d002_unit_004_rule_id_severity_matches_registry.py']


def test_review_report_severity_matches_registry_variant_contract() -> None:
