# URN: test:validate-conventions:coherence-variants:rule_id_registry_coherence
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `coherence/rule_id_registry_coherence` (#1206).
...
VARIANT = "rule_id_registry_coherence"
...
LEGACY_PARITY_SOURCES = ['src/atdd/coach/validators/test_rule_id_registry_coherence.py']


def test_rule_id_registry_coherence_variant_contract() -> None:
