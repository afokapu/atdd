# URN: test:validate-conventions:binding-variants:rule_validator_binding
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `binding/rule_validator_binding` (#1206).
...
VARIANT = "rule_validator_binding"
...
LEGACY_PARITY_SOURCES = ['src/atdd/coach/validators/test_rule_validator_binding.py']


def test_rule_validator_binding_variant_contract() -> None:
