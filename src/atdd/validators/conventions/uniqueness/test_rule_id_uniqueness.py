# URN: test:validate-conventions:uniqueness-variants:rule_id_uniqueness
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `uniqueness/rule_id_uniqueness` (#1206).
...
LEGACY_PARITY_SOURCES = ['src/atdd/coach/validators/test_rule_id_uniqueness.py']


def test_rule_id_uniqueness_variant_contract() -> None:
