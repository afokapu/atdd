# URN: test:validate-conventions:resolution-variants:metric_implementation_resolves
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `resolution/metric_implementation_resolves` (#1206).
...
VARIANT = "metric_implementation_resolves"
...
LEGACY_PARITY_SOURCES = ['src/atdd/tester/validators/test_metric_implementation.py']


def test_metric_implementation_resolves_variant_contract() -> None:
