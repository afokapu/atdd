# URN: test:validate-conventions:resolution-variants:security_ref_resolution
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `resolution/security_ref_resolution` (#1206).
...
VARIANT = "security_ref_resolution"
...
LEGACY_PARITY_SOURCES = ['src/atdd/tester/validators/test_security_ref_binding.py']


def test_security_ref_resolution_variant_contract() -> None:
