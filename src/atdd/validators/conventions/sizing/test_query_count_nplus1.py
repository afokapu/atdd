# URN: test:validate-conventions:sizing-variants:query_count_nplus1
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `sizing/query_count_nplus1` (#1206).
...
LEGACY_PARITY_SOURCES = ['src/atdd/coder/validators/test_query_count.py']


def test_query_count_nplus1_variant_contract() -> None:
