# URN: test:validate-conventions:sizing-variants:complexity_python
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `sizing/complexity_python` (#1206).
...
LEGACY_PARITY_SOURCES = ['src/atdd/coder/validators/test_complexity.py']


def test_complexity_python_variant_contract() -> None:
