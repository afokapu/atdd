# URN: test:validate-conventions:sizing-variants:hook_size_limit
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `sizing/hook_size_limit` (#1206).
...
LEGACY_PARITY_SOURCES = ['src/atdd/coder/validators/test_god_hook_elimination.py']


def test_hook_size_limit_variant_contract() -> None:
