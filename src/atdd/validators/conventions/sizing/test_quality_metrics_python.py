# URN: test:validate-conventions:sizing-variants:quality_metrics_python
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `sizing/quality_metrics_python` (#1206).
...
VARIANT = "quality_metrics_python"
...
LEGACY_PARITY_SOURCES = ['src/atdd/coder/validators/test_quality_metrics.py']


def test_quality_metrics_python_variant_contract() -> None:
