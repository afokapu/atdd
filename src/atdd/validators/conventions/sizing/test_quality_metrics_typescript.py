# URN: test:validate-conventions:sizing-variants:quality_metrics_typescript
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `sizing/quality_metrics_typescript` (#1206).
...
VARIANT = "quality_metrics_typescript"
...
LEGACY_PARITY_SOURCES = ['src/atdd/coder/validators/test_quality_metrics_typescript.py']


def test_quality_metrics_typescript_variant_contract() -> None:
