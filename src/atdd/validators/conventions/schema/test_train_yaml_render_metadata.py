# URN: test:validate-conventions:schema-variants:train_yaml_render_metadata
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `schema/train_yaml_render_metadata` (#1206).
...
VARIANT = "train_yaml_render_metadata"
...
LEGACY_PARITY_SOURCES = ['src/atdd/coder/validators/test_train_yaml_render_metadata.py']


def test_train_yaml_render_metadata_variant_contract() -> None:
