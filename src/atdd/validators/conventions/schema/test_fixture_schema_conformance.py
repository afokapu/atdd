# URN: test:validate-conventions:schema-variants:fixture_schema_conformance
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `schema/fixture_schema_conformance` (#1206).
...
VARIANT = "fixture_schema_conformance"
...
LEGACY_PARITY_SOURCES = ['src/atdd/tester/validators/test_fixture_validity.py']


def test_fixture_schema_conformance_variant_contract() -> None:
