# URN: test:validate-conventions:schema-variants:plan_wagons
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `schema/plan_wagons` (#1206).
...
LEGACY_PARITY_SOURCES = ['src/atdd/planner/validators/test_plan_wagons.py']


def test_plan_wagons_variant_contract() -> None:
