# URN: test:validate-conventions:policy-variants:no_polluting_patterns
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `policy/no_polluting_patterns` (#1206).
...
LEGACY_PARITY_SOURCES = ['src/atdd/tester/validators/test_no_polluting_patterns.py']


def test_no_polluting_patterns_variant_contract() -> None:
