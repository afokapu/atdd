# URN: test:validate-conventions:policy-variants:live_smoke_no_self_skip
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `policy/live_smoke_no_self_skip` (#1206).
...
VARIANT = "live_smoke_no_self_skip"
...
LEGACY_PARITY_SOURCES = ['src/atdd/tester/validators/test_live_smoke_execution.py']


def test_live_smoke_no_self_skip_variant_contract() -> None:
