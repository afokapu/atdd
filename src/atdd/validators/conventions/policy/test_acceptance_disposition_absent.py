# URN: test:validate-conventions:policy-variants:acceptance_disposition_absent
# WMBT: wmbt:validate-conventions:E010
# Phase: GREEN
# Layer: integration
# Assertion: behavioral
"""Convention validator variant `policy/acceptance_disposition_absent` (#1206).
...
VARIANT = "acceptance_disposition_absent"
...
LEGACY_PARITY_SOURCES = ['src/atdd/tester/validators/test_acceptance_disposition.py']


def test_acceptance_disposition_absent_variant_contract() -> None:
