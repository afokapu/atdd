# URN: test:govern-lifecycle:enforce-smoke-refactor-phase-substrate:E070-UNIT-003-closes-keyword-gate-scopes-to-pr-under-validation
# Acceptance: acc:govern-lifecycle:E070-UNIT-003-closes-keyword-gate-scopes-to-pr-under-validation
# WMBT: wmbt:govern-lifecycle:E070
# Phase: GREEN
# Layer: unit
# Assertion: behavioral
"""E070-UNIT-003 — the twin gate scopes to the PR under validation too.
