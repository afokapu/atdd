# URN: test:govern-lifecycle:enforce-smoke-refactor-phase-substrate:E070-UNIT-001-branch-pr-resolves-through-prmanager-seam
# Acceptance: acc:govern-lifecycle:E070-UNIT-001-branch-pr-resolves-through-prmanager-seam
# WMBT: wmbt:govern-lifecycle:E070
# Phase: GREEN
# Layer: unit
# Assertion: behavioral
"""E070-UNIT-001 — the branch leg of the current-PR resolver returns the PR number.
