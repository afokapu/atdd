...
class URNCommand:
    ...
    def graph(
        ...
        try:
            ...
            _log.warning("graph: Exception handled, reporting failure to the caller (exit 1)", extra={"error": str(e)[:200]})
    ...
    def viz(
        ...
        try:
            ...
            _log.debug("viz: ImportError handled, reporting failure to the caller (exit 1)", extra={"error": str(exc)[:200]})
            print(
        ...
        try:
            ...
            _log.warning("viz: KeyboardInterrupt handled, reporting success to the caller", extra={"error": str(exc)[:200]})
            return 0
    ...
    def orphans(
        ...
        try:
            ...
            _log.warning("orphans: Exception handled, reporting failure to the caller (exit 1)", extra={"error": str(e)[:200]})
    ...
    def broken(
        ...
        try:
            ...
            _log.warning("broken: Exception handled, reporting failure to the caller (exit 1)", extra={"error": str(e)[:200]})
    ...
    def validate(
        ...
        try:
            ...
            _log.warning("validate: Exception handled, reporting failure to the caller (exit 1)", extra={"error": str(e)[:200]})
    ...
    def _run_substrate_conformance(self, format: str = "text") -> int:
        ...
        try:
            ...
            _log.warning("_run_substrate_conformance: (OSError, FileNotFoundError) handled, reporting failure to the caller (exit 1)", extra={"error": str(exc)[:200]})
            if format != "json":
                print(
    ...
    def resolve(self, urn: str, format: str = "text") -> int:
        ...
        try:
            ...
            _log.warning("resolve: Exception handled, reporting failure to the caller (exit 1)", extra={"error": str(e)[:200]})
    ...
    def declarations(
        ...
        try:
            ...
            _log.warning("declarations: Exception handled, reporting failure to the caller (exit 1)", extra={"error": str(e)[:200]})
