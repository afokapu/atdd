...
class URNCommand:
    ...
    def viz(
        ...
        except ImportError:  # atdd:suppress(coder.logging.coach-silent-swallow) UNTIL=2026-08-31
            print(
        ...
        except KeyboardInterrupt:  # atdd:suppress(coder.logging.coach-silent-swallow) UNTIL=2026-08-31
            return 0
