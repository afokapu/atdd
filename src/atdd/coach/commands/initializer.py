...
"""
        ...
        # baseline-sync job RETIRED (#481): it emitted `run: atdd baseline
        # update` — a subcommand the 3.x CLI never declared — which failed
        # `invalid choice: 'baseline'` on every push to main. Ratchet
        # baselines (#223) were superseded by disposition gates (#395), so
        # the job was dead scaffolding. No emit means no drift.
        baseline_sync_job = ""
