...
_EXTRA_SECTION = "## External-Section-581\n\nContent injected by external PR — not in template.\n"
...
def test_sync_warns_about_removed_lines(tmp_path: Path, capsys: pytest.CaptureFixture[str]) -> None:
    ...
    assert "External-Section-581" in out or "would remove" in out or "force" in out, \
