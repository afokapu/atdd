...
# Purpose: RED skeleton for acc:project-shared-state:E004-SMOKE-001-uid-mint — fails until the project-shared-state wagon implements it (train 0006). Refs #1433.
"""RED skeleton for acc:project-shared-state:E004-SMOKE-001-uid-mint.
...
def test_e004_smoke_001_uid_mint(tmp_path) -> None:
    """E004-SMOKE-001-uid-mint — behaviour not yet implemented."""
    raise AssertionError(
        "RED: project-shared-state acceptance acc:project-shared-state:E004-SMOKE-001-uid-mint is not implemented yet"
    )
