...
# Purpose: RED skeleton for acc:migrate-projection-authority:K001-UNIT-002-exit-criteria-met-after-cutover — fails until the migrate-projection-authority wagon implements it (train 0006). Refs #1400.
"""RED skeleton for acc:migrate-projection-authority:K001-UNIT-002-exit-criteria-met-after-cutover.
...
def test_k001_unit_002_exit_criteria_met_after_cutover(tmp_path) -> None:
    """K001-UNIT-002-exit-criteria-met-after-cutover — behaviour not yet implemented."""
    raise AssertionError(
        "RED: migrate-projection-authority acceptance acc:migrate-projection-authority:K001-UNIT-002-exit-criteria-met-after-cutover is not implemented yet"
    )
