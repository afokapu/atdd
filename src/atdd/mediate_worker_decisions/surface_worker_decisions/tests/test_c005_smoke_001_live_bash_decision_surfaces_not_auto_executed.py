# URN: test:mediate-worker-decisions:surface-worker-decisions:C005-SMOKE-001-live-bash-decision-surfaces-not-auto-executed
# Acceptance: acc:mediate-worker-decisions:C005-SMOKE-001-live-bash-decision-surfaces-not-auto-executed
# WMBT: wmbt:mediate-worker-decisions:C005
# Phase: SMOKE
# Layer: integration
# Assertion: behavioral
"""C005-SMOKE-001 — a worker's Bash command surfaces instead of auto-executing.
